  ...
  return (
    <div className="space-y-6">
      ...
      <section aria-labelledby="user-info-section">
        <h3 id="user-info-section" className="text-lg font-semibold text-[#4A5568] mb-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Card>
            <CardContent className="pt-6">
              ...
              <div className="text-2xl font-bold text-[#4A5568] mt-1">{user.gender === 'F' ? 'Féminin' : 'Masculin'}</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="pt-6">
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="text-sm text-[#4A5568] opacity-70">Dernière activité</div>
              <div className="text-lg font-semibold text-[#4A5568] mt-1">{user.lastActivity}</div>
            </CardContent>
          </Card>
        </div>
      </section>
      ...
      <section aria-labelledby="metrics-section">
        <h3 id="metrics-section" className="text-lg font-semibold text-[#4A5568] mb-4">
          Métriques de Santé
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <CardContent className="pt-6">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-[#4A5568] opacity-70 mt-1">pas/jour</p>
                </div>
                <div className="w-12 h-12 rounded-lg bg-[#4A90E2] bg-opacity-10 flex items-center justify-center">
                  <Activity className="w-6 h-6 text-[#4A90E2]" aria-hidden="true" />
                </div>
              </div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="text-sm text-[#4A5568] opacity-70">Calories Moyennes</div>
                  <div className="text-3xl font-bold text-[#4A5568] mt-2">
                    {metrics.currentMetrics.avgCalories}
                  </div>
                  <p className="text-sm text-[#4A5568] opacity-70 mt-1">kcal/jour</p>
                </div>
                <div className="w-12 h-12 rounded-lg bg-[#FF887B] bg-opacity-10 flex items-center justify-center">
                  <Activity className="w-6 h-6 text-[#FF887B]" aria-hidden="true" />
                </div>
              </div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  <div className="text-sm text-[#4A5568] opacity-70">Progression Objectif</div>
                  <div className="text-3xl font-bold text-[#4A5568] mt-2">
                ...
                <div className="w-12 h-12 rounded-lg bg-[#5CC58C] bg-opacity-10 flex items-center justify-center">
                  <Target className="w-6 h-6 text-[#5CC58C]" aria-hidden="true" />
                </div>
              </div>
              <Progress 
      ...
      <section aria-labelledby="charts-section">
        <h3 id="charts-section" className="text-lg font-semibold text-[#4A5568] mb-4">
          Analyses d'Activité
        </h3>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <div role="img" aria-label="Graphique en barres montrant l'activité quotidienne de l'utilisateur comparée à son objectif de 10000 pas sur les 7 derniers jours.">
          ...
          <Card>
            ...
            <CardContent>
              <div role="img" aria-label="Graphique linéaire montrant les calories consommées et brûlées de l'utilisateur sur 4 semaines.">
                <ResponsiveContainer width="100%" height={300}>
